...
int connsys_spi_master_cfg_mt6983(unsigned int curr_status, unsigned int next_status)
{
	if (curr_status != 0)
		return 0;
...
int connsys_a_die_cfg_mt6983(unsigned int curr_status, unsigned int next_status)
{
