...
int connsys_spi_master_cfg_mt6983_atf(unsigned int curr_status, unsigned int next_status);
int connsys_a_die_cfg_mt6983_atf(unsigned int curr_status, unsigned int next_status);
