...
enum ENUM_TXPWR_CONNECT_SCE {
	TXPWR_CONNECT_SCE_SINGLE,
	TXPWR_CONNECT_SCE_DBDC,
	TXPWR_CONNECT_SCE_NUM
};
...
u_int8_t rlmDomainIsIndoorBw20(struct ADAPTER *prAdapter,
				 enum ENUM_BAND eBand, uint8_t ucChannel);
