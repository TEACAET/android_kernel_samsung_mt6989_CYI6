...
struct CMD_SCAN_REQ_V2 {
	...
	struct PARAM_SSID    arSSIDExtend[SCAN_CMD_EXT_SSID_NUM];
	...
	uint16_t         u2LLWMaxDwellTimeMs;
	uint16_t         u2LLWMinDwellTimeMs;
	uint8_t          aucPadding_3[15];
