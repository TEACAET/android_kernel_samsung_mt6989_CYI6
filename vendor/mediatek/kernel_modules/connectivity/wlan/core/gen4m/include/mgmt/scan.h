...
#define AP_SELECTION_DESC_STALE_SEC		20
...
#define BSSDESC_RCPI_TIMEOUT			10
...
struct SCAN_INFO {
	...
	boolean fgIsNeedPSCScan;
	uint32_t au4ChannelBitMap[SCAN_CHANNEL_BITMAP_ARRAY_LEN];
	uint8_t ucPSCChannelNum;
	uint8_t ucPSCChannelMap[MAX_6GPSC_CHANNEL_NUM];
