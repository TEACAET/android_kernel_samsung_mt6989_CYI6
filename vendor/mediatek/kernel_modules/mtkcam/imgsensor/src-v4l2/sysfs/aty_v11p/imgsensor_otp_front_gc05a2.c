...
#define FRONT_GC05A2_MAX_CAL_SIZE               (0x0682 + 26)
#define FRONT_GC05A2_HEADER_CHECKSUM_LEN        (0x004D - 0x0000 + 0x1)
#define FRONT_GC05A2_MODULE_DATA_CHECKSUM_LEN   (0x0460 - 0x0052)

#define FRONT_GC05A2_CONVERTED_MAX_CAL_SIZE     (0x0A03  + 0x1)
#define FRONT_GC05A2_CONVERTED_AWB_CHECKSUM_LEN (0x0067 - 0x005C + 0x1)
#define FRONT_GC05A2_CONVERTED_LSC_CHECKSUM_LEN (0x07C7 - 0x006C + 0x1)

const struct rom_converted_cal_addr front_gc05a2_converted_cal_addr = {
	.rom_awb_cal_data_start_addr     = 0x005C,
	.rom_awb_checksum_addr           = 0x0068,
	.rom_awb_checksum_len            = FRONT_GC05A2_CONVERTED_AWB_CHECKSUM_LEN,
	.rom_shading_cal_data_start_addr = 0x006C,
	.rom_shading_checksum_addr       = 0x07C8,
	.rom_shading_checksum_len        = FRONT_GC05A2_CONVERTED_LSC_CHECKSUM_LEN,
};

const struct imgsensor_vendor_rom_addr front_gc05a2_cal_addr = {
	/* Set '-1' if not used */

	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = FRONT_GC05A2_MAX_CAL_SIZE,
	...
	.rom_header_checksum_addr               = 0x004E,
	.rom_header_checksum_len                = (FRONT_GC05A2_HEADER_CHECKSUM_LEN),
	...
	.rom_module_checksum_addr               = 0x0460,
	.rom_module_checksum_len                = (FRONT_GC05A2_MODULE_DATA_CHECKSUM_LEN),
	...
	.converted_cal_addr                     = &front_gc05a2_converted_cal_addr,
	.rom_converted_max_cal_size             = FRONT_GC05A2_CONVERTED_MAX_CAL_SIZE,
