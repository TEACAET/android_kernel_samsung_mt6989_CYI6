...
#define REAR_SC800CS_MAX_CAL_SIZE               (0x0809 + 0x1)

#define REAR_SC800CS_HEADER_CHECKSUM_LEN        (0x00CB - 0x0000 + 0x1)
#define REAR_SC800CS_OEM_CHECKSUM_LEN           (0x01AB - 0x0160 + 0x1)
#define REAR_SC800CS_AWB_CHECKSUM_LEN           (0x01CB - 0x01B0 + 0x1)
#define REAR_SC800CS_SHADING_CHECKSUM_LEN       (0x05CB - 0x01D0 + 0x1)

#define REAR_SC800CS_DUAL_CHECKSUM_LEN          -1
#define REAR_SC800CS_PDAF_CHECKSUM_LEN          -1
#define REAR_SC800CS_OIS_CHECKSUM_LEN           -1

#define REAR_SC800CS_CONVERTED_MAX_CAL_SIZE     (0x0B59 + 0x1)
#define REAR_SC800CS_CONVERTED_AWB_CHECKSUM_LEN (0x01BB - 0x01B0 + 0x1)
#define REAR_SC800CS_CONVERTED_LSC_CHECKSUM_LEN (0x091B - 0x01C0 + 0x1)

const struct rom_converted_cal_addr rear_sc800cs_converted_cal_addr = {
	.rom_awb_cal_data_start_addr            = 0x01B0,
	.rom_awb_checksum_addr                  = 0x01BC,
	.rom_awb_checksum_len                   = (REAR_SC800CS_CONVERTED_AWB_CHECKSUM_LEN),
	.rom_shading_cal_data_start_addr        = 0x01C0,
	.rom_shading_checksum_addr              = 0x091C,
	.rom_shading_checksum_len               = (REAR_SC800CS_CONVERTED_LSC_CHECKSUM_LEN),
};

const struct imgsensor_vendor_rom_addr rear_sc800cs_cal_addr = {
	/* Set '-1' if not used */
	.camera_module_es_version               = 'A',
	.cal_map_es_version                     = '1',
	.rom_max_cal_size                       = REAR_SC800CS_MAX_CAL_SIZE,
	...
	.rom_header_checksum_len                = REAR_SC800CS_HEADER_CHECKSUM_LEN,
	...
	.rom_oem_checksum_len                   = REAR_SC800CS_OEM_CHECKSUM_LEN,
	...
	.rom_awb_checksum_len                   = REAR_SC800CS_AWB_CHECKSUM_LEN,

	.rom_shading_cal_data_start_addr        = 0x01D0,
	.rom_shading_module_info_start_addr     = -1,
	.rom_shading_checksum_addr              = 0x05CC,
	.rom_shading_checksum_len               = REAR_SC800CS_SHADING_CHECKSUM_LEN,
	...
	.converted_cal_addr                     = &rear_sc800cs_converted_cal_addr,
	.rom_converted_max_cal_size             = REAR_SC800CS_CONVERTED_MAX_CAL_SIZE,

	.sensor_maker                           = "SMARTSENS", // SENSOR_MAKER NAME
	.sensor_name                            = "SC800CS",
